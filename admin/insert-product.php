...
<div class="control-group">
<label class="control-label" for="basicinput">Album/Single Name</label>
<div class="controls">
<input type="text"    name="productName"  placeholder="Enter Album/Single Name" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Enter Artist Name" class="span8 tip" required>
</div>
</div>
<div class="control-group">
